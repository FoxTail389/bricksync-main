...
// frontend/node_modules/@gradio/theme/src/colors.ts
var ordered_colors = [
  "red",
  "green",
  "blue",
...
var colors = color_values.reduce(
...
// frontend/node_modules/@gradio/utils/src/color.ts
var get_next_color = (index) => {
  return ordered_colors[index % ordered_colors.length];
};

// frontend/node_modules/@gradio/utils/src/utils.ts
...
async function uploadToHuggingFace(data, type) {
  ...
  if (!uploadResponse.ok) {
    if ((_a = uploadResponse.headers.get("content-type")) == null ? void 0 : _a.includes("application/json")) {
...
//# sourceMappingURL=@gradio_utils.js.map
