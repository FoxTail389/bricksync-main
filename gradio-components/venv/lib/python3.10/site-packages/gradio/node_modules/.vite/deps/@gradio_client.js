import "./chunk-IRAQY57I.js";

// frontend/node_modules/@gradio/client/dist/index.js
  ...
  async function client2(app_reference, options = { normalise_files: true }) {
    return new Promise(async (res) => {
      ...
      if ((typeof window === "undefined" || !("WebSocket" in window)) && !global.Websocket) {
        const ws = await import("./wrapper-6f348d45-FFT2TPZA.js");
        NodeBlob = (await import("./node_buffer-6JIGYPUQ.js")).Blob;
